    ...
    return (
      <div className="h-full bg-gradient-to-br from-card to-inner rounded-2xl border border-edge p-5 flex flex-col overflow-hidden">
        ...
        <div className="flex items-center gap-3 mb-5 flex-shrink-0">
          ...
          <div>
            <h2 className="text-lg font-semibold text-heading">Evening Review</h2>
            <p className="text-xs text-dim">Reflect on your day</p>
          </div>
        </div>

        {/* Today's Summary */}
        {focus && (
          <div className="flex-shrink-0 p-3 bg-inner rounded-xl border border-edge mb-4">
            <div className="flex items-center justify-between mb-2">
              <p className="text-xs text-dim uppercase">Today&apos;s Progress</p>
              <p className="text-sm font-medium text-accent">{completedTasks}/{totalTasks} tasks</p>
            </div>
        ...
        <div className="flex-1 min-h-0 overflow-y-auto space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-3 bg-inner border border-edge rounded-xl text-heading placeholder-gray-500 focus:outline-none focus:border-green-500/50 transition-colors resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-3 bg-inner border border-edge rounded-xl text-heading placeholder-gray-500 focus:outline-none focus:border-amber-500/50 transition-colors resize-none"
            />
          </div>
          ...
          <div>
            <label className="block text-sm font-medium text-sub mb-2">
              <span className="text-accent mr-1">↑</span> What will I improve tomorrow?
            </label>
            <textarea
              value={improvements}
              ...
              rows={2}
              className="w-full px-4 py-3 bg-inner border border-edge rounded-xl text-heading placeholder-gray-500 focus:outline-none focus:border-accent/50 transition-colors resize-none"
            />
          </div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full px-4 py-3 bg-inner border border-edge rounded-xl text-heading placeholder-gray-500 focus:outline-none focus:border-purple-500/50 transition-colors resize-none"
            />
          </div>
        </div>
    ...
    <div className="h-full bg-gradient-to-br from-card to-inner rounded-2xl border border-edge p-5 flex flex-col overflow-hidden relative">
      ...
      <div className="flex items-center justify-between mb-4 flex-shrink-0">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-semibold text-heading">Evening Review</h2>
            <p className="text-xs text-dim">Today&apos;s reflections</p>
          </div>
        </div>
        <button
          type="button"
      ...
      <div className="flex-1 min-h-0 overflow-y-auto space-y-4">
        ...
        {reflection?.wentWell && (
          <div className="p-3 bg-inner rounded-lg border border-edge">
            ...
            <p className="text-sm text-sub">{reflection.wentWell}</p>
          </div>
        )}
        ...
        {reflection?.challenges && (
          <div className="p-3 bg-inner rounded-lg border border-edge">
            ...
            <p className="text-sm text-sub">{reflection.challenges}</p>
          </div>
        )}
        ...
        {reflection?.improvements && (
          <div className="p-3 bg-inner rounded-lg border border-edge">
            ...
            <p className="text-sm text-sub">{reflection.improvements}</p>
          </div>
        )}
        ...
        {reflection?.gratitude && (
          <div className="p-3 bg-inner rounded-lg border border-edge">
            ...
            <p className="text-sm text-sub italic">&ldquo;{reflection.gratitude}&rdquo;</p>
          </div>
        )}
      </div>
    </div>
